...
if (!class_exists('Reli_Data_Tag')) {
    class Reli_Data_Tag
    {
        ...
        {
            self::$current_tag = get_queried_object();
        ...
        public static function meat()
        {
            ...
            $array = array(
                'id' => self::$current_tag->term_id, //分类ID
                'link'=>get_category_link(self::$current_tag),//分类链接
                'name' => self::$current_tag->name, //分类名称
                'description' => self::$current_tag->description, //分类描述
            );
            return $array;
        }
        /**
        ...
        public static function single()
        {
            ...
            $args = array(
                'category_name' => self::$current_tag->slug, // 使用当前分类的别名作为查询参数
            );
